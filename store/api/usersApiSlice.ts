...
const usersApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getUser: builder.query<IUserResponse, undefined>({
      ...
      providesTags: (result, error, id) => (result ? [{type: 'User', id}] : ['User']),
    }),
    // updateUser:
    // deleteUser:
  }),
...
export const {useGetMeQuery, useUpdateMeMutation, useGetUsersQuery, useGetUserQuery} = usersApiSlice
...
} = usersAdapters.getSelectors((state: any) => selectUsersData(state) ?? initialState)
