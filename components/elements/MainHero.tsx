...
const css = {
  ...
  inner: 'relative rounded-xl overflow-hidden pt-[40%] md:pt-0 md:h-96 lg:h-[450px]',
  ...
  title: 'text-3xl sm:text-4xl lg:text-6xl font-bold text-white',
  action: 'mt-6 sm:mt-8',
          ...
          <div className={css.action}>
            <Link href="/shop">
              <a className={css.link}>
                Explore More <ArrowNarrowRightIcon className={css.icon} />
              </a>
            </Link>
          </div>
        </div>
