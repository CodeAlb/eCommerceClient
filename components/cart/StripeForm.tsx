...
import {clearCart, getCartState} from '../../store/slices/cartSlice'
import {FormEvent, useEffect, useRef, useState} from 'react'
import {useRouter} from 'next/router'
import {cn, numToPrice, getSessionStorage} from '../../utils/helpers'
import {useStripeConnectMutation} from '../../store/api/paymentsApiSlice'
...
const StripeForm = () => {
  ...
  const [stripePayment] = useStripeConnectMutation()
